...
SWIGINTERN PyObject *_wrap_test_func(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ColMatrix< float > result;
  
  if (!PyArg_ParseTuple(args,(char *)":test_func")) SWIG_fail;
  result = test_func();
  {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"test_func", _wrap_test_func, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
